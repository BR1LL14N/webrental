...
<body>
        <!-- Navbar -->
    <div class="navbar bg-gradient-to-r from-primary to-secondary text-white shadow-lg sticky top-0 z-50">
        <div class="navbar-start">
        <div class="dropdown">
            <label tabindex="0" class="btn btn-ghost lg:hidden">
            <i class="fas fa-bars text-xl"></i>
            </label>
        <ul tabindex="0" class="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52 text-dark">
            <li><a>Home</a></li>
            <li><a>Cars</a></li>
            <li><a>Services</a></li>
            <li><a>About</a></li>
    ...
    <a class="btn btn-ghost normal-case text-xl">DriveLux</a>
    </div>
    ...
    <div class="navbar-end">
        <a class="btn btn-accent text-white">Book Now</a>
    </div>
</div>
